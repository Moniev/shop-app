...
ActiveRecord::Schema[8.0].define(version: 20_250_725_205_037) do
  ...
  create_table 'product_likes', force: :cascade do |t|
    ...
    t.index %w[user_id product_id], name: 'index_product_likes_on_user_id_and_product_id', unique: true
  ...
  create_table 'product_rates', force: :cascade do |t|
    ...
    t.index %w[user_id product_id], name: 'index_product_rates_on_user_id_and_product_id', unique: true
